...
# # Route to view all users (with basic auth protection)
# @authentication_blueprint.route('/auth/users', methods=['GET'])
# def get_all_users():
#     # Check for Basic Authentication
#     auth = request.authorization
#     if not auth or auth.username != os.getenv('BASIC_AUTH_USER') or auth.password != os.getenv('BASIC_AUTH_PASSWORD'):
